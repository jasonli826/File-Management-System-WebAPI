...
namespace FileDetailAPI.Repository
{
    ...
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        {
            var existingAuthorCount = _appDBContext.Departments.Where(a => a.DepartmentName==objDepartment.DepartmentName);
            if (existingAuthorCount.Count() > 0)
            {
                objDepartment.DepartmentId = 500;
            }
            else
            {
